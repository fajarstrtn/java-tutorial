...
/*
 * extends keyword means "is a subtype of" whether it is a class or an interface.
 ...
 * 
 * Since Groom generic class extends Animal and implements Serializable,
 * both Cat and Dog should extend and implement both of them.
 * 
