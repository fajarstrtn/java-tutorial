...
public class StringManipulation {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Compare Amsterdam with amsterdam lexicographically, then it becomes " + cityName.compareTo("amsterdam") + ".");
        System.out.println("Compare with ignoring case between Amsterdam and amsterdam lexicographically, then it becomes " + cityName.compareToIgnoreCase("amsterdam") + ".");
        System.out.println("Format Amsterdam to be in lower case is " + cityName.toLowerCase() + ".");
